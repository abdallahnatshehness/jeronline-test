Feature: Testing contractorEmpRight page
...
#    Then I check that the current page number is  "1"
  ...
  Scenario: Footer check if displayed
    ...
    When I add "3" in widget " חודשים לבדיקה"
    When I remove "1" in widget " חודשים לבדיקה"
    When I remove "3" in widget " חודשים לבדיקה"
    When I remove "2" in widget " חודשים לבדיקה"


#    Then I check if the "footer_new" is exist
#
#  @critical
